package com.bridgelabz.addressbookappdevelopmentapplication.exception;
...
public class AddressBookExceptionHandler {
  ...
  public ResponseEntity<ResponseDTO> handleMethodArgumentNotValidException(
      ...
      log.error("Invalid phoneNumber Format", exception);
      ResponseDTO respDTO = new ResponseDTO(message, "Should have phoneNumber in 10 digit followed by the country code");
